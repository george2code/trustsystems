...
class SubcategoriesControllerTest < ActionController::TestCase
  ...
  test "should create subcategory" do
    assert_difference('Subcategory.count') do
      post :create, subcategory: { description: @subcategory.description, name: @subcategory.name, rootCategoryId: @subcategory.rootCategoryId, slug: @subcategory.slug }
    end
  ...
  test "should update subcategory" do
    patch :update, id: @subcategory, subcategory: { description: @subcategory.description, name: @subcategory.name, rootCategoryId: @subcategory.rootCategoryId, slug: @subcategory.slug }
    assert_redirected_to subcategory_path(assigns(:subcategory))
  end
